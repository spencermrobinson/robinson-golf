...
const apparel_size = [{label: "Med", value: "Med"},{label: "X-Small", value: "X-Small"},{label: "Small", value: "Small"},{label: "Large", value: "Large"},{label: "X-Large", value: "X-Large"},{label: "XX-Large", value: "XX-Large"}];
